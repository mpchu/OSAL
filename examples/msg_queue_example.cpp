...
void osal_queue_example()
{
    ...
    osal::task p1(
        ...
        producer_task, 1, 1s, 3, std::ref(msgQ));
    ...
    osal::task p2(
        osal::task_attributes()
            ...
            .set_stack_size(stack_size)
            .set_priority(priority),
        producer_task, 2, 600ms, 1, std::ref(msgQ));
    ...
    osal::task p3(
        osal::task_attributes()
            ...
            .set_stack_size(stack_size)
            .set_priority(priority),
        producer_task, 3, 3s, 4, std::ref(msgQ));
    ...
    osal::task p4(
        osal::task_attributes()
            ...
            .set_stack_size(stack_size)
            .set_priority(priority),
        producer_task, 4, 800ms, 2, std::ref(msgQ));
    ...
    osal::task p5(
        osal::task_attributes()
            ...
            .set_stack_size(stack_size)
            .set_priority(priority),
        producer_task, 5, 2s, 3, std::ref(msgQ));
